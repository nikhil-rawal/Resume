window.onload = function () {/*==================== MENU SHOW Y HIDDEN ====================*/
    ...
    const modalBtns = document.querySelectorAll('.hobbies__button');
    const modalCloses = document.querySelectorAll('.hobbies__modal-close');
